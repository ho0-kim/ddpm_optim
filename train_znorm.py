...
from grad_optim.Adam import Adam
...
def train(rank=0, args=None, temp_dir=""):
    ...
    optimizer = Adam(model.parameters(), lr=train_config.lr, betas=(train_config.beta1, train_config.beta2), use_pj=True, use_znorm=True)
